...
import { ChartThemePalette, ChartThemeOptions, ChartThemeOverrides } from "../chartOptions";
...
export class ChartTheme {
    ...
    constructor(options?: ChartThemeOptions) {
        ...
        if (isObject(options)) {
            ...
            options = deepMerge({}, options, mergeOptions) as ChartThemeOptions;
    ...
    private static cartesianSeriesTypes: (keyof ChartThemeOverrides)[] = ['line', 'area', 'bar', 'column', 'scatter', 'histogram'];
    private static polarSeriesTypes: (keyof ChartThemeOverrides)[] = ['pie'];
    private static seriesTypes: (keyof ChartThemeOverrides)[] = ChartTheme.cartesianSeriesTypes.concat(ChartTheme.polarSeriesTypes);
